...
public class ComputeStats6MalesInTop10MostPopulousStatesTest
{
    [Fact]
    public void SingleStateWithAllMalesTest()
    {
        ...
        var actual = stats.ComputeStats6MalesInTop10MostPopulousStates(userData);
    ...
    [Fact]
    public void TwoStateWithEqualNumberOfMalesTest()
    {
        var stats = new StatisticsService();
        var userData = new List<NCRPerson>
        {
    ...
    [Fact]
    public void ElevenStateWithDifferentNumberOfMalesTest()
    {
        var stats = new StatisticsService();
        var userData = new List<NCRPerson>
        {
            // Main should be excluded since it has one male eventhough it has a higher percentage than Florida
            new NCRPerson { Gender = "male", Location = new NCRLocation { State = "Main" } },
            new NCRPerson { Gender = "female", Location = new NCRLocation { State = "Main" } },
            ...
            new NCRPerson { Gender = "male", Location = new NCRLocation { State = "Colorado" } },
            new NCRPerson { Gender = "male", Location = new NCRLocation { State = "Colorado" } },
            new NCRPerson { Gender = "male", Location = new NCRLocation { State = "Colorado" } },
            ...
            new NCRPerson { Gender = "male", Location = new NCRLocation { State = "Kentucky" } },
            new NCRPerson { Gender = "male", Location = new NCRLocation { State = "Kentucky" } },
            new NCRPerson { Gender = "male", Location = new NCRLocation { State = "Kentucky" } },
            new NCRPerson { Gender = "male", Location = new NCRLocation { State = "Kentucky" } },
            ...
            new NCRPerson { Gender = "male", Location = new NCRLocation { State = "Wisconsin" } },
            new NCRPerson { Gender = "male", Location = new NCRLocation { State = "Wisconsin" } },
            new NCRPerson { Gender = "male", Location = new NCRLocation { State = "Wisconsin" } },
            new NCRPerson { Gender = "male", Location = new NCRLocation { State = "Wisconsin" } },
    ...
    [Fact]
    public void NoStateWithMalesTest()
    {
        var stats = new StatisticsService();
        var userData = new List<NCRPerson>
        {
